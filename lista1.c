...
void q05(){
    ...
    scanf("%d", &numero reais);
    printf("numero real foi %¨d\n",)
}
//6. Faça um programa que leia um número inteiro e imprima o seu
//   antecessor e o seu sucessor.
void q06 (){
    int numero;
    printf("digite o numero inteiro e imprima o antecessor e o sucessor");
    scanf("%d" ,&numero reais);
    printf("numero real foi %d\n")
}
...
//   subtração deles.
void q08(){}
printf ("digite os numeros inteiro e subtraia "){
scanf(" %20[^\n]",numero);
}
//9. Faça um programa que leia umnúmero real e imprima ¼ deste número.
void q09(){
printf ("digite um numero real e 1/4:"){
scanf("%d numero reais ;"){
scanf("numero real foi ;"){
}
